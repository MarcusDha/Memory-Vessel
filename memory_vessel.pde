...
void setup() {
  ...
  sky(0, 0);
  field(0, 0);
  for (int y = 550; y < 750; y += 25) {
    for (int x = 0; x <= 1000; x += 10) {
      
      flowers((int)random(0, width), (int)random(550, 650),colors[ (int)random(0, 5) ], s);
    }
  }
  ...
  for (int y = 550; y < 750; y += 35) {
    for (int x = 0; x <= 1000; x += 30) {
      ...
      flowers((int)random(0, width), (int)random(650, 750),colors[ (int)random(0, 5) ], s);
    }
  }
  ...
  for (int y = 750; y <= height; y += 55) {
    for (int x = 0; x <= width; x += 50) {
      ...
      flowers((int)random(0, width), (int)random(750, 960),colors[ (int)random(0, 5) ], s);
    }
  }
